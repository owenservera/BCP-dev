...
W2  PROVIDERS ........ 13+8 manifests → realization rows+handlers (Chrome-mediated first — automation IS the product everywhere in v1, no AI-API realization; the local-model pilot ordering is void, see banner above, D-418/D-456) + launch scope + stealth admission + governor
