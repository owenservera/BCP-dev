# Communication How-To — CFA-04 Authority / Governance

**Agent identity seed:** `authority-governance`  
**Agent home:** `AGENTS_CONTEXT/ARCHITECTURE_STEWARD/SUBAGENTS/AUTHORITY-GOVERNANCE`
