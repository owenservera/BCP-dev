# Communication How-To — CFA-08 Experience / Interaction / Surfaces

**Agent identity seed:** `experience-interaction-surfaces`  
**Agent home:** `AGENTS_CONTEXT/ARCHITECTURE_STEWARD/SUBAGENTS/EXPERIENCE-INTERACTION-SURFACES`
