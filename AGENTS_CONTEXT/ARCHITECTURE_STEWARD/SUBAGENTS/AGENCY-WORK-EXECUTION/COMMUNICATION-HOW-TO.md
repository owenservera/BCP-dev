# Communication How-To — CFA-05 Agency / Work / Execution

**Agent identity seed:** `agency-work-execution`  
**Agent home:** `AGENTS_CONTEXT/ARCHITECTURE_STEWARD/SUBAGENTS/AGENCY-WORK-EXECUTION`
