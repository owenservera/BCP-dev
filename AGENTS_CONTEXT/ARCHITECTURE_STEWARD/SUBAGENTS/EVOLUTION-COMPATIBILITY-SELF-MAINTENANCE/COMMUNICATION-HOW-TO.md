# Communication How-To — CFA-09 Evolution / Compatibility / Self-Maintenance

**Agent identity seed:** `evolution-compatibility-self-maintenance`  
**Agent home:** `AGENTS_CONTEXT/ARCHITECTURE_STEWARD/SUBAGENTS/EVOLUTION-COMPATIBILITY-SELF-MAINTENANCE`
