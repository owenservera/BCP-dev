# Communication How-To — CFA-06 Capability / Provider / Realization

**Agent identity seed:** `capability-provider-realization`  
**Agent home:** `AGENTS_CONTEXT/ARCHITECTURE_STEWARD/SUBAGENTS/CAPABILITY-PROVIDER-REALIZATION`
