# Communication How-To — CFA-10 Runtime Constitution / Core Substrate

**Agent identity seed:** `runtime-constitution-core-substrate`  
**Agent home:** `AGENTS_CONTEXT/ARCHITECTURE_STEWARD/SUBAGENTS/RUNTIME-CONSTITUTION-CORE-SUBSTRATE`
