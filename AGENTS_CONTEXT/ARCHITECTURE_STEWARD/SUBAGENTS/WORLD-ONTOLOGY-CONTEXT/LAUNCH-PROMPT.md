...
**Candidate workspace:** `AGENTS_CONTEXT/ARCHITECTURE_STEWARD/SUBAGENTS/WORLD-ONTOLOGY-CONTEXT/`  
...
Read the existing destination ontology/conceptual-model material, Product Vision context, current Architecture Graph, Product Experience Archaeology, and any Ω material covering WorldModel, EntityView/live objects, context assembly, grounding, relationship/object identity, Space, Attention, Address, Memory and deterministic world reconstruction. Inspect `AGENTS_CONTEXT/PRODUCT_VISION/`, relevant `docs/destination/` packages, and `omega-baseline/omega-final/` contracts/plugins for these subjects.
...
Steward the semantic boundary between the user's World, Things, Relationships, Spaces, Context, Attention and Address; determine what the world means, how identity and relationships participate in that meaning, and how context is derived without becoming a second ontology or persistence authority.
...
World, Thing/Object semantics, semantic identity correspondence, relationship meaning, Space, Context, Attention, Address, world projection and semantic reconciliation where required to define world meaning. Explicitly test the boundary with Data/Persistence, Self-Knowledge/Command, Experience/Surfaces and Evidence.
...
Does Ontology need to be a distinct permanent responsibility from World/Context? Where should semantic identity reconciliation live? Where does Context stop and Self-Knowledge or Work-context begin? Which WorldModel responsibilities are semantic versus projection?
