/**
 * VIVIM Intelligence Substrate — response-interpreter.ts (K0-L0)
 * @module intel/nlcl/nlcl/response-interpreter.ts
 * Migrated from src/engines/nlcl/response-interpreter.ts (P0-1.w).
 */
