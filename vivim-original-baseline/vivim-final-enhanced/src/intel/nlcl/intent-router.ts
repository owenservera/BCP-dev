/**
 * VIVIM Intelligence Substrate — intent-router.ts (K0-L0)
 * @module intel/nlcl/nlcl/intent-router.ts
 * Migrated from src/engines/nlcl/intent-router.ts (P0-1.w).
 */
...
import type { ActionPlan, CapabilityRisk } from '../../engines/nlcl/action-plan.js'
