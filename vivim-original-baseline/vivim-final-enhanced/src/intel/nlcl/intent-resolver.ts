/**
 * VIVIM Intelligence Substrate — intent-resolver.ts (K0-L0)
 * @module intel/nlcl/nlcl/intent-resolver.ts
 * Migrated from src/engines/nlcl/intent-resolver.ts (P0-1.w).
 */
