/**
 * VIVIM Intelligence Substrate — nlcl-otel.ts (K0-L0)
 * @module intel/nlcl/nlcl/nlcl-otel.ts
 * Migrated from src/engines/nlcl/nlcl-otel.ts (P0-1.w).
 */
...
import { getOtelSink } from '../../engines/nlcl/otel-sink.js'
