/**
 * VIVIM Intelligence Substrate — Browser Executor (K0-L0)
 * @module intel/nlcl/executors/browser-executor
 * Migrated from src/engines/nlcl/executors/browser-executor.ts (P0-1.w).
 */
...
import type { CommandExecutor, CommandResult, NLCContext, ParsedIntent } from '../../engines/nlcl/types.js'
