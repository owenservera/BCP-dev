/**
 * VIVIM Intelligence Substrate — parameter-extraction.ts (K0-L0)
 * @module intel/nlcl/nlcl/parameter-extraction.ts
 * Migrated from src/engines/nlcl/parameter-extraction.ts (P0-1.w).
 */
