/**
 * VIVIM Intelligence Substrate — layered-resolver.ts (K0-L0)
 * @module intel/nlcl/nlcl/layered-resolver.ts
 * Migrated from src/engines/nlcl/layered-resolver.ts (P0-1.w).
 */
