/**
 * VIVIM Intelligence Substrate — nlcl-engine.ts (K0-L0)
 * @module intel/nlcl/nlcl/nlcl-engine.ts
 * Migrated from src/engines/nlcl/nlcl-engine.ts (P0-1.w).
 */
...
import type { ActionPlan, GroundedReference } from '../../engines/nlcl/action-plan.js'
import { ActionPlanBridge } from '../../engines/nlcl/action-plan-bridge.js'
import type { ChromeGovernor } from '../../engines/nlcl/chrome-governor.js'
import type { ConversationManager } from '../../engines/nlcl/conversation-manager.js'
import type { ExecutionKernel } from '../../engines/nlcl/execution-kernel.js'
import { OpenCodeExecutor } from '../opencode/opencode-executor.js'
import { PlanValidationGate } from '../../engines/nlcl/plan-validation-gate.js'
import type { EmbeddingProvider } from '../../engines/nlcl/semantic-search.js'
import type { UnifiedCapabilityRegistry } from '../../engines/nlcl/unified-registry.js'
