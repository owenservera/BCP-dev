/**
 * VIVIM Intelligence Substrate — text-normalizer.ts (K0-L0)
 * @module intel/nlcl/nlcl/text-normalizer.ts
 * Migrated from src/engines/nlcl/text-normalizer.ts (P0-1.w).
 */
