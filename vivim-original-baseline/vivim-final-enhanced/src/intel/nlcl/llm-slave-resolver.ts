/**
 * VIVIM Intelligence Substrate — llm-slave-resolver.ts (K0-L0)
 * @module intel/nlcl/nlcl/llm-slave-resolver.ts
 * Migrated from src/engines/nlcl/llm-slave-resolver.ts (P0-1.w).
 */
...
import { HfEmbeddingProvider } from '../../engines/nlcl/embedding-hf.js'
