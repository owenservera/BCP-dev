/**
 * VIVIM Intelligence Substrate — workflow-synthesis-resolver.ts (K0-L0)
 * @module intel/nlcl/nlcl/workflow-synthesis-resolver.ts
 * Migrated from src/engines/nlcl/workflow-synthesis-resolver.ts (P0-1.w).
 */
