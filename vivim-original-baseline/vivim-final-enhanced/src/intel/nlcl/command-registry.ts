/**
 * VIVIM Intelligence Substrate — Command Pattern Registry (K0-L0)
 * @module intel/nlcl/command-registry
 *
 * Migrated from src/engines/nlcl/command-registry.ts (P0-1.w).
 * Types remain at K1 location ../../engines/nlcl/types.js.
 */
...
import type { CommandPattern, NLCLSurface } from '../../engines/nlcl/types.js'
