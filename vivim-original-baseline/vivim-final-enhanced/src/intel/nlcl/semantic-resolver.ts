/**
 * VIVIM Intelligence Substrate — semantic-resolver.ts (K0-L0)
 * @module intel/nlcl/nlcl/semantic-resolver.ts
 * Migrated from src/engines/nlcl/semantic-resolver.ts (P0-1.w).
 */
