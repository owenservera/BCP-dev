/**
 * VIVIM Intelligence Substrate — types.ts (K0-L0)
 * @module intel/nlcl/nlcl/types.ts
 * Migrated from src/engines/nlcl/types.ts (P0-1.w).
 */
...
import type { CapabilitySurface } from '../../engines/nlcl/unified-registry.js'
