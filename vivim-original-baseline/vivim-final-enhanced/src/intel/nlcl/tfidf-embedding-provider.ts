/**
 * VIVIM Intelligence Substrate — tfidf-embedding-provider.ts (K0-L0)
 * @module intel/nlcl/nlcl/tfidf-embedding-provider.ts
 * Migrated from src/engines/nlcl/tfidf-embedding-provider.ts (P0-1.w).
 */
