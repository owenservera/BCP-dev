/**
 * VIVIM Intelligence Substrate — Dialogue Session Store (K0-L0)
 * @module intel/nlcl/dialogue-session-store
 * Migrated from src/engines/nlcl/dialogue-session-store.ts (P0-1.w).
 */
