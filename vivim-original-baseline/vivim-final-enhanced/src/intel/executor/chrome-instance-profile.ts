/**
 * VIVIM Intelligence Substrate — Chrome Instance Profile (K0-L0)
 * @module intel/executor/chrome-instance-profile
 * Migrated from src/executor/chrome-instance-profile.ts (P0-3).
 * Mechanism: universal Chrome profile lifecycle (no VIVIM product dependency).
 */
