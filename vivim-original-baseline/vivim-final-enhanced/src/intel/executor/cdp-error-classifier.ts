/**
 * VIVIM Intelligence Substrate — CDP Error Classifier (K0-L0)
 * @module intel/executor/cdp-error-classifier
 * Migrated from src/executor/cdp-error-classifier.ts (P0-3).
 */
