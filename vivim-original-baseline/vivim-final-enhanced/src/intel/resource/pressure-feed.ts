/**
 * VIVIM Intelligence Substrate — Pressure Feed (K0-L0)
 * @module intel/resource/pressure-feed
 * Migrated from src/engines/resource/pressure-feed.ts (P0-3).
 * Mechanism: universal resource monitoring (no product-specific dependency).
 */
