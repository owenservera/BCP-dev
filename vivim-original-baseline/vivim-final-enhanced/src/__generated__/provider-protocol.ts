...
// Generated at: 2026-07-27T18:55:47.500Z
// Providers: 20
...
const _protocol: ProviderProtocol = {
  ...
  providers: [
    ...
    },
    {
      ...
      endpoints: [
        ...
        },
        {
          ...
          composerSelector:
            'div[contenteditable="true"].ProseMirror,div[contenteditable="true"][data-placeholder]',
          sendButtonSelector: "[aria-label='Send Message'],[aria-label='Send message']",
    ...
    },
    {
      ...
      composerSelectors: ['.ql-editor[contenteditable="true"]', 'textarea'],
    ...
    },
    {
      ...
      config: { auth_type: 'x.com', base_url: 'https://x.com' },
    },
    {
      slug: 'mistral',
      displayName: 'Mistral',
      ...
      capabilities: [
        {
          ...
          recoveryStrategies: [{ type: 'retry_selector' }, { type: 'navigate_home' }],
          uiComponentOverride: 'text_input',
          uiLabelOverride: 'Send to Mistral',
          uiIconOverride: 'arrow-up-circle',
          uiPositionOverride: 'composer',
          uiOrderOverride: undefined,
          uiGroupOverride: '',
      ...
      config: { auth_type: 'email', base_url: 'https://chat.mistral.ai' },
    },
    {
      slug: 'nonexistent_provider_xyz',
      displayName: 'nonexistent_provider_xyz',
      description: '',
      category: 'ai',
      providerType: 'llm',
      authType: 'browser',
      ...
      hasMultiAccount: false,
      isActive: true,
      urlPattern: '^https://nonexistent_provider_xyz\\.com',
      url: 'https://nonexistent_provider_xyz.com',
      loginUrl: 'https://nonexistent_provider_xyz.com/login',
      composerSelectors: ['textarea'],
      sendButtonSelectors: ['button[type="submit"]'],
      loginIndicator: { urlPattern: 'login|auth|signin|sign-in' },
      endpoints: [],
