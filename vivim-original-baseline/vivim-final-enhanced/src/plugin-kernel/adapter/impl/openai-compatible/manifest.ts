/**
 * VIVIM Plugin-Kernel — OpenAI-Compatible Manifest Schema
 * @module plugin-kernel/adapter/impl/openai-compatible/manifest
 *
 ...
 *
 * Migrated from src/ai/protocol/openai-compatible/manifest.ts. Imports kept
 * at pre-split K1 paths; will collapse when K-012 (types.ts SPLIT) lands.
 */
