/**
 * VIVIM Plugin-Kernel — OpenAI-Compatible Error Mapper
 * @module plugin-kernel/adapter/impl/openai-compatible/error-mapper
 *
 * Maps OpenAI API errors → VivimAIError. Never lets a provider-native
 * exception cross the adapter boundary.
 *
 * Migrated from src/ai/protocol/openai-compatible/error-mapper.ts. Imports
 * kept at the pre-split K1 paths (../../../../ai/core/...); will collapse
 * to ../../../core/... once K-012 (types.ts SPLIT) lands.
 */

import { AI_ERRORS, type VivimAIError } from '../../../../ai/core/errors.js'
import type { ProviderId } from '../../../../ai/core/types.js'
