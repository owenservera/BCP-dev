/**
 * VIVIM Plugin-Kernel — In-Memory Event Bus (K-006)
 * @module plugin-kernel/event-bus/in-memory
 *
 ...
 *
 * Migrated from src/ai/events/in-memory-bus.ts. The IEventBus contract
 * (K-005) still lives at src/ai/events/bus.ts because its migration
 * has not been dispatched yet; once K-005 lands, the import path below
 * collapses to './contract.js' (relative to this file).
 */

import type { ProviderId, ResourceUsage } from '../../ai/core/types.js'
import type { GatewayEvent, GatewayEventFilter, IEventBus } from '../../ai/events/bus.js'
