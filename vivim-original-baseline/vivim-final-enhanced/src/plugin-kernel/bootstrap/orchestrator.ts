// src/plugin-kernel/bootstrap/orchestrator.ts
// K0-15 glue. The boot-ORDER pipeline. This file IS the dependency graph: the phase list
...
//
// Migrated from src/server/bootstrap/orchestrator.ts. The phase siblings
// (seeds, stores, knowledge, capabilities, lifecycle) and the BootstrapContext
// type still live in their K1 location; the relative path to them from this
// K0 file is './phases/<name>.js' (already correct) and './context.js' (still
// correct). Cross-zone references to engines/lib/... go up 2 levels to src/.

import { UnifiedCapabilityRegistry } from '../../engines/unified-registry.js'
import { getLogger } from '../../lib/logger.js'
import type { BootstrapContext, BootstrapEnginesResult } from '../../server/bootstrap/context.js'
import { createBootstrapContext } from '../../server/bootstrap/context.js'
import { bootstrapCapabilitiesPhase } from '../../server/bootstrap/phases/capabilities.js'
import { bootstrapKnowledgePhase } from '../../server/bootstrap/phases/knowledge.js'
import { bootstrapLifecyclePhase } from '../../server/bootstrap/phases/lifecycle.js'
import { bootstrapSeedsPhase } from '../../server/bootstrap/phases/seeds.js'
import { bootstrapStoresPhase } from '../../server/bootstrap/phases/stores.js'
