# STATUS (cleanup 2026-09-23): PARKED. EXP-2026-005 is MERGING — the final
# stand-by directive below remains valid, EXCEPT the b2-consumption-confirm item:
# still owed, owned by the coordinator on resume, not by a new agent act.
# Earlier AMENDMENT/LOOP entries are completed history. Resume only on a new
