# SETUP-PROMPT-IMPL-02 — Saved owner setup prompt (verbatim below the line)

> **Classification: wrapper DERIVED — CURRENT; body = owner's mission word (TRANSCRIPT-class)**
> **Saved by:** COORD-01 (this session) · **Received:** 2026-09-23 · **Routed agent:** IMPL-02
> **Workstream:** WS-001 · **Base tip at save:** `becb920`
> **Relation to transcript:** byte-twin of the charter stored at
> `../../transcripts/2026-09-23/CHAT-2026-09-23-cooperative-agent-context.md`
> (that file is the immutable historical record; THIS file is the launch
> artifact the owner points agents at). Frozen — supersede with `-v2`, never edit.
> **Launch companion:** `LAUNCH-IMPL-02.md` (starting position — read second).

---
--- VERBATIM OWNER PROMPT FOLLOWS (nothing above this line is the prompt) ---
---
...
*(End of verbatim prompt as received from owner, 2026-09-23. Saved by COORD-01.)*
